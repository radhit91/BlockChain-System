	    ...
	    while (1) {
			...
			switch(msg_type){
				case 0: {
					...
					if(replica->flag == 1){
					message = std::to_string(msg_type) + "x" + std::to_string(replica->replica_name) + "x" + std::to_string(replica->max_ballot) + "x" + std::to_string(replica->last_prop_val) + "x" + std::to_string(replica->last_log_pos) + "x" + std::to_string(replica->flag) + "x" + std::to_string(replica->sender);
